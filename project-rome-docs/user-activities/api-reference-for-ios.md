# <a name="ios-user-activities-api-reference"></a><span data-ttu-id="be588-101">iOS 사용자 활동 API 참조</span><span class="sxs-lookup"><span data-stu-id="be588-101">iOS User Activities API reference</span></span>
