# <a name="ios-device-relay-api-reference"></a><span data-ttu-id="d4d6d-101">iOS 장치 릴레이 API 참조</span><span class="sxs-lookup"><span data-stu-id="d4d6d-101">iOS Device Relay API reference</span></span>
